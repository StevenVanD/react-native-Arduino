...
var ReactProvider = function (_Provider) {
  ...
  (0, _createClass3.default)(ReactProvider, [{
    ...
    value: function renderPreview(kind, story) {
      ...
      this.channel.emit(_coreEvents2.default.SET_CURRENT_STORY, { kind: kind, story: story });
    ...
    value: function handleAPI(api) {
      ...
      api.onStory(function (kind, story) {
        ...
        _this2.channel.emit(_coreEvents2.default.SET_CURRENT_STORY, _this2.selection);
      });
      this.channel.on(_coreEvents2.default.SELECT_STORY, function (_ref2) {
        var kind = _ref2.kind,
            story = _ref2.story;
      ...
      this.channel.on(_coreEvents2.default.GET_CURRENT_STORY, function () {
        _this2.channel.emit(_coreEvents2.default.SET_CURRENT_STORY, _this2.selection);
      });
      this.channel.emit(_coreEvents2.default.GET_STORIES);
