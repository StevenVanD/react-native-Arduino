...
var StoryListView = function (_Component) {
  ...
  function StoryListView(props) {
    ...
    _this.props.stories.on(_coreEvents2.default.STORY_ADDED, _this.storyAddedHandler);
    return _this;
  }
  ...
  (0, _createClass3.default)(StoryListView, [{
    ...
    value: function componentWillUnmount() {
      this.props.stories.removeListener(_coreEvents2.default.STORY_ADDED, this.storyAddedHandler);
    }
  }, {
    key: 'handleStoryAdded',
    value: function handleStoryAdded() {
      if (this.props.stories) {
        var data = this.props.stories.dumpStoryBook().map(function (section) {
          return {
            title: section.kind,
    ...
    value: function changeStory(kind, story) {
      this.props.events.emit(_coreEvents2.default.SET_CURRENT_STORY, { kind: kind, story: story });
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      return _react2.default.createElement(_reactNative.SectionList, {
        ...
        renderSectionHeader: function renderSectionHeader(_ref5) {
          ...
          return _react2.default.createElement(SectionHeader, { title: title, selected: title === _this2.props.selectedKind });
        },
