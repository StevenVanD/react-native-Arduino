...
var StoryView = function (_Component) {
  ...
  function StoryView(props) {
    ...
    _this.forceRender = _this.forceUpdate.bind(_this);

    _this.props.events.on(_coreEvents2.default.SELECT_STORY, _this.storyHandler);
    _this.props.events.on(_coreEvents2.default.FORCE_RE_RENDER, _this.forceRender);
    return _this;
  }
  ...
  (0, _createClass3.default)(StoryView, [{
    ...
    value: function componentWillUnmount() {
      this.props.events.removeListener(_coreEvents2.default.SELECT_STORY, this.storyHandler);
      this.props.events.removeListener(_coreEvents2.default.FORCE_RE_RENDER, this.forceRender);
    }
  }, {
    key: 'selectStory',
    value: function selectStory(selection, storyFn) {
