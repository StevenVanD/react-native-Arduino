...
var Preview = function () {
  ...
  (0, _createClass3.default)(Preview, [{
      ...
      return function () {
        ...
        if (!channel || params.resetStorybook) {
          if (params.onDeviceUI && params.disableWebsockets) {
            channel = new _events.EventEmitter();
          } else {
          ...
          channel.emit(_coreEvents2.default.CHANNEL_CREATED);
        }

        channel.on(_coreEvents2.default.GET_STORIES, function () {
          return _this3._sendSetStories();
        });
        channel.on(_coreEvents2.default.SET_CURRENT_STORY, function (d) {
        ...
        return params.onDeviceUI ? _react2.default.createElement(_OnDeviceUI2.default, { stories: _this3._stories, events: channel, url: webUrl }) : _react2.default.createElement(_StoryView2.default, { url: webUrl, events: channel });
      };
    }
  }, {
    key: '_sendSetStories',
    value: function _sendSetStories() {
      ...
      channel.emit(_coreEvents2.default.SET_STORIES, { stories: stories });
    }
  }, {
    key: '_sendGetCurrentStory',
    value: function _sendGetCurrentStory() {
      var channel = _addons2.default.getChannel();
      channel.emit(_coreEvents2.default.GET_CURRENT_STORY);
    }
  }, {
    key: '_selectStory',
    value: function _selectStory(selection) {
      ...
      var channel = _addons2.default.getChannel();
      channel.emit(_coreEvents2.default.SELECT_STORY, selection, storyFn);
    }
  }]);
  return Preview;
}();
