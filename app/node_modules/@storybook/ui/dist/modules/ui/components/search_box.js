...
var SearchBox = function (_React$Component) {
  ...
  function SearchBox() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref2 = SearchBox.__proto__ || (0, _getPrototypeOf2.default)(SearchBox)).call.apply(_ref2, [this].concat(args))), _this), _this.state = {}, _this.onSelect = function (selected) {
  ...
  (0, _createClass3.default)(SearchBox, [{
    ...
    value: function render() {
      ...
      var _state = this.state,
          overlayClass = _state.overlayClass,
          modalClass = _state.modalClass;
